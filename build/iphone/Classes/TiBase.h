...
// in simulator we redefine to format for testClearTop Developer console
...
{\
	NSString * exceptionName = [@"org.testcleartop." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.testcleartop";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UItestClearTopNativeItemNone = -1, 
	UItestClearTopNativeItemSpinner = -2,
	UItestClearTopNativeItemProgressBar = -3,
	
	UItestClearTopNativeItemSlider = -4,
	UItestClearTopNativeItemSwitch = -5,
	UItestClearTopNativeItemMultiButton = -6,
	UItestClearTopNativeItemSegmented = -7,
	
	UItestClearTopNativeItemTextView = -8,
	UItestClearTopNativeItemTextField = -9,
	UItestClearTopNativeItemSearchBar = -10,
	
	UItestClearTopNativeItemPicker = -11,
	UItestClearTopNativeItemDatePicker = -12,
	
	UItestClearTopNativeItemInfoLight = -13,
	UItestClearTopNativeItemInfoDark = -14,
	
	UItestClearTopNativeItemDisclosure = -15,
	
	UItestClearTopNativeItemContactAdd = -16
};
